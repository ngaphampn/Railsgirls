...
class BingosControllerTest < ActionController::TestCase
  ...
  test "should create bingo" do
    assert_difference('Bingo.count') do
      post :create, bingo: { description: @bingo.description, name: @bingo.name, picture: @bingo.picture }
    end
  ...
  test "should update bingo" do
    patch :update, id: @bingo, bingo: { description: @bingo.description, name: @bingo.name, picture: @bingo.picture }
    assert_redirected_to bingo_path(assigns(:bingo))
  end
